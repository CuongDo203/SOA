...
public enum ErrorCode {
        ...
        SET_STUDENT_CHECK_EMPTY(1009, "Set of student check cannot be empty", HttpStatus.BAD_REQUEST),
        STUDENT_CODE_INVALID_FORMAT(1010, "Student code is not the correct format, standard format Example: B21DCCN189", HttpStatus.BAD_REQUEST)
    ;
